...
export const Calculator = () => {
    ...
    if (item.action === BTN_ACTIONS.CALC) {
      ...
      try {
        ...
        setTimeout(() => {
          ...
          expDiv.innerHTML = "";
          addAnimSapan(Math.floor(res * 100000000) / 100000000);
        }, 200);
      } catch {
        setTimeout(() => {
          cloneNode.style.transform = transform;
  ...
  return (
    <div className="calculator">
      ...
      <div ref={btnRef} className="calculator_btns">
        {btns.map((item, index) => (
          <button
            key={index}
